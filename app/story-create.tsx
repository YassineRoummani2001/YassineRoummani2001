...
export default function StoryCreateScreen() {
            ...
            if (mode === 'video' || mode === 'image') {
                if (Platform.OS === 'web') {
                    ...
                    try {
                        ...
                        console.error("Failed to convert media to base64 on web", e);
                    }
                } else {
    ...
    return (
        ...
        >
            <StatusBar hidden />
            <TouchableOpacity style={styles.closeBtn} onPress={() => setMode('select')}>
            ...
            <View style={styles.bottomBarStatic}>
...
const styles = StyleSheet.create({
    ...
    // Old styles preserved/updated if needed for other modes
    textHeader: {
        flexDirection: 'row',
    ...
    closeBtn: { position: 'absolute', top: 50, left: 24, zIndex: 20, shadowColor: 'black', shadowOpacity: 0.5, shadowRadius: 2 },
